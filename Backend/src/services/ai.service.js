...
const interviewReportSchema = z.object({
    ...
    })).describe("Technical questions that can be asked in the interview along with their intention and how to answer them").min(5),
    ...
    })).describe("List of skill gaps in the candidate's profile along with their severity").min(5),
...
async function generateInterviewReport({ resume, selfDescription, jobDescription }) {
    ...
    behavioralQuestions: same format
