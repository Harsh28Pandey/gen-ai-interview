...
async function generateInterviewReport({ resume, selfDescription, jobDescription }, retries = 2) {
    try {
...
`;
        ...
        return generateInterviewReport({ resume, selfDescription, jobDescription }, retries - 1);
    }
}
